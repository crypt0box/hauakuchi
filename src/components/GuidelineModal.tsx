...
type GuidelineModalProps = Omit<ModalProps, "children">;
    ...
    <Modal isOpen={isOpen} onClose={onClose} isCentered>
      ...
      <ModalContent mx={{ base: "4" }} py="30">
        ...
        <ModalBody overflowY="scroll" maxH="90vh">
          <div>
            <div>
              <h1 style={{ fontWeight: "bold" }}>利用規約</h1>
              <p>
                この利用規約（以下，「本規約」といいます。）は，cryptobox（以下，「運営者」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
              </p>
              <h2 style={{ fontWeight: "bold" }}>第1条（適用）</h2>
              <ol>
                <li>
              ...
              <h2 style={{ fontWeight: "bold" }}>第2条（利用登録）</h2>
              <ol>
                <li>
              ...
              <h2 style={{ fontWeight: "bold" }}>第5条（禁止事項）</h2>
              <p>
              ...
              <h2 style={{ fontWeight: "bold" }}>第7条（著作権）</h2>
              <ol>
                <li>
              ...
              <h2 style={{ fontWeight: "bold" }}>第9条（退会）</h2>
              <p>
              ...
              <h2 style={{ fontWeight: "bold" }}>第12条（利用規約の変更）</h2>
              <ol>
                <li>
              ...
              <h2 style={{ fontWeight: "bold" }}>第13条（個人情報の取扱い）</h2>
              <p>
                運営者は，本サービスの利用によって取得する個人情報については，運営者「プライバシーポリシー」に従い適切に取り扱うものとします。
              </p>

              <h2 style={{ fontWeight: "bold" }}>第14条（通知または連絡）</h2>
              <p>
              ...
              <h2 style={{ fontWeight: "bold" }}>第16条（準拠法・裁判管轄）</h2>
              <ol>
