    ...
    try {
      ...
      if (err.response?.status === 429) {
        toast({
          ...
          description:
            "たくさん投稿してくれてありがとうございます。とても嬉しいです。本当は無制限に投稿できるようにしたいんですけどね。そうするとお金がかかりすぎちゃって、運営者の財布がペラペラになっちゃうんです。でも心配しないでください。10分くらい経ったらまた投稿できるようになります。その間YouTubeを見るとか、軽く運動するとか、ちょっとその辺を散歩してくるとかすればすぐです。そしたらこんなちっぽけなサイトの存在なんて忘れて、Twitterという古巣に戻っているかもしれないけど、はやくちで語りたいことができたらいつでも戻ってきてくださいね",
          status: "error",
          duration: null,
          isClosable: true,
        });
